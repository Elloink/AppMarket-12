...
public class MarketActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// ArrayAdapter<AppItem>(this,android.R.layout.simple_list_item_1,appList);
		...
		public void handleMessage(Message msg) {
			...
			case MSG_QUERY:
				if (msg.arg1 == QUERY_SUCCESS) {
					PictureAdapter adapter = new PictureAdapter(appList,
							MarketActivity.this, baseUrl);
					gridView.setAdapter(adapter);
					gridView.setOnItemClickListener(new OnItemClickListener() {
						public void onItemClick(AdapterView<?> parent, View v,
								int position, long id) {
							AppItem item = appList[position];
							Intent intent1 = new Intent(MarketActivity.this,
					...
					Toast.makeText(MarketActivity.this, "网络读取失败，请检查网络配置或服务器",
	...
	class MyThread extends Thread {
		...
		public void run() {
			...
			try {
				appList = restTemplate.getForObject(baseUrl + "/getapps",
						AppItem[].class);
